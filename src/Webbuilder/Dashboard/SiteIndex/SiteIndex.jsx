...
import { H1, H2, H1Subtitle, H2Subtitle } from '../../../components/Headings/Headings'
            ...
            <div className="pb-">
              ...
              {SiteStore.activated &&
                <section  className="site-general-wrapper">
                  ...
                  <H2>Danger Zone</H2>
                  <H2Subtitle>This is permanent. If you delete your site, you can create it again, but everything will be lost.</H2Subtitle>
                  <MainButton
                    value="Delete Site"
