...
const SignupPage = inject("UserStore")(
  observer(({ UserStore }) => {
    ...
    const getParams = () => {
      ...
      if (approvalStatus !== false) {
        UserStore.getAccessToken(approvalStatus).then((res) => {
          if (!res) {
            toast.error(
              "Something went wrong with authentication. Please try again. Redirecting..."
            );
            setTimeout(() => {
        ...
        toast.error(
          "In order to progress, please 'Allow' Reddex to connect to your account. Redirecting..."
        );
        ...
        <DisplayWrapper>
          <div className="flex flex-col items-center mt-4">
            ...
            <p className="subtle mb-6">
              ...
              This is so you can have access to your inbox, and the ability to
