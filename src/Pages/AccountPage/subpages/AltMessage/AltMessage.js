...
const AltMessage = ({UserStore, repeatGreeting, setRepeatGreeting}) => {
  ...
  return (
    <section className="default-message animated fadeIn faster">
      ...
      <H2Subtitle>This is used when you've already messaged an author. It's useful so users don't feel like they're just getting copy and pasted messages.</H2Subtitle>
